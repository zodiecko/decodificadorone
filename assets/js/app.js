...
function copiarParaAreaDeTransferencia () {
  const copyText = document.getElementById('texto-final').innerHTML
...
function isTextoVazio () {
  const valor = document.getElementById('texto-digitado').value
...
function criptografar () {
  ...
  const textoSplitador = document.getElementById('texto-digitado').value.split('')
  let novoTexto = ''
